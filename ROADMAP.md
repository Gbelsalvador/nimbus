...
Below is the planned feature roadmap for this project.

Each item includes a **priority level** (`P1` = High, `P2` = Medium, `P3` = Low).  
Priorities and scope may change as feedback and development progress.
